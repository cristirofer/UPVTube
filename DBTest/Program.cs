...
namespace DBTest
{
    class Program
    {
        ...
        private void CreateSampleDB(IDAL dal)
        {
            ...
            Comment com1 = new Comment("test comment", DateTime.Now, c1, a1);
            dal.Insert<Comment>(com1);
            dal.Commit();

            Evaluation e1 = new Evaluation(DateTime.Now, "test", a1, c1);
            dal.Insert<Evaluation>(e1);
            dal.Commit();

            Subject s1 = new Subject(9999, "Test Subject", "test");
            dal.Insert<Subject>(s1);
            dal.Commit();

            Visualization v1 = new Visualization(DateTime.Now, c1, a1);
